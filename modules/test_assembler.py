...
class TestAssembler(unittest.TestCase):
    def setUp(self):
        ...
        checked_programs = [os.path.join("modules", "program_examples", "checked_complete_risc.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_complete_stack.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_complete_accumulator.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_complete_cisc.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_label_stack.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_label_accumulator.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_label_risc.bin"),
                            os.path.join("modules", "program_examples",
                                         "checked_label_cisc.bin"),
    ...
    def test_accumulator(self):
        ...
        self.assertEqual(self.complete_accumulator,
                         self.checked_complete_accumulator)
        self.assertEqual(self.label_accumulator,
                         self.checked_label_accumulator)
    ...
    def test_errors(self):
        ...
        with self.assertRaises(AssemblerError):
            Assembler("accumulator", "mov_low $4, $0")
        with self.assertRaises(AssemblerError):
