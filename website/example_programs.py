...
stack_examples = [alphabets[0], hellos[0], bubble_sorts[0],
                  polynomials[0], 'input assembly code here']
accumulator_examples = [alphabets[1], hellos[1],
                        bubble_sorts[1], polynomials[1], 'input assembly code here']
risc_examples = [alphabets[2], hellos[2], bubble_sorts[2],
                 polynomials[2], 'input assembly code here']
cisc_examples = [alphabets[3], hellos[3],
                 bubble_sorts[3], polynomials[3], simd]

# That dictionary is used later in the web app
examples = {'stack': stack_examples, 'accumulator': accumulator_examples,
            'risc': risc_examples, 'cisc': cisc_examples}
